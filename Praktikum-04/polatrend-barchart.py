...
import pandas as pd
st.title("Pola dan Trend Bar Chart")
st.write("Kelompok: 25")
st.markdown(""" Rochmad Bima Setyawan (0110122152) Silvia Pitriani (0110222136) Pandu Linggar Kumara (0110221277)""")
# Data jumlah mahasiswa per jurusan selama 5 tahun
data = { 'Tahun': ['2019', '2020', '2021', '2022', '2023'],
